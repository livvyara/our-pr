  ...
  return (
    <div className="home-page-container">
      ...
      <main className="home-page-content">
        ...
        {/* 1. 히어로 섹션 (메인 배너) */}
        <section className="home-page-hero-section" style={{ backgroundImage: `url(${HERO_BG})` }}>
          <div className="home-page-hero-overlay">
            <div className="home-page-hero-text-box">
              ...
              <div className="home-page-hero-buttons">
                <button className="home-page-btn-primary-hero" onClick={() => navigate('/guide/apply')}>파트너 신청하기</button>
                <button className="home-page-btn-secondary-hero" onClick={() => navigate('/community/inquiry')}>이용 문의</button>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="home-page-features-section">
          ...
          <div className="home-page-features-grid">
            <div className="home-page-feature-card">
              <div className="home-page-icon-wrapper"><img src={ICON_1} alt="견적 관리" /></div>
              <h3>투명한 견적 관리</h3>
              <p>복잡한 엑셀 없이 체계적인 견적서를 작성하고 고객에게 바로 공유하세요.</p>
            </div>
            <div className="home-page-feature-card">
              <div className="home-page-icon-wrapper"><img src={ICON_2} alt="일정 관리" /></div>
              <h3>스마트한 일정표</h3>
              <p>공사 일정을 한눈에 파악하고, 변경 사항을 실시간으로 고객과 공유합니다.</p>
            </div>
            <div className="home-page-feature-card">
              <div className="home-page-icon-wrapper"><img src={ICON_3} alt="파트너" /></div>
              <h3>검증된 파트너</h3>
        ...
        {/* 3. 통계/신뢰 섹션 */}
        <section className="home-page-stats-section">
        ...
        {/* 4. 이용 방법 (프로세스) */}
        <section className="home-page-process-section">
          <div className="home-page-section-title">
            <h2>이용 프로세스</h2>
            <p>아워프로젝트와 함께하는 성공적인 인테리어</p>
          </div>
          <div className="home-page-process-steps">
            <div className="home-page-step-item">
              <span className="home-page-step-num">01</span>
              <h4>회원가입/파트너신청</h4>
              <p>간단한 정보 입력으로<br/>서비스를 시작하세요.</p>
            </div>
            <div className="home-page-step-arrow">→</div>
            <div className="home-page-step-item">
              <span className="home-page-step-num">02</span>
              <h4>현장 등록 & 초대</h4>
              <p>현장을 개설하고<br/>고객(도급인)을 초대하세요.</p>
            </div>
            <div className="home-page-step-arrow">→</div>
            <div className="home-page-step-item">
              <span className="home-page-step-num">03</span>
              <h4>일정/공정 관리</h4>
              <p>작업 일지와 공정을<br/>투명하게 공유하세요.</p>
            </div>
            <div className="home-page-step-arrow">→</div>
            <div className="home-page-step-item">
              <span className="home-page-step-num">04</span>
              <h4>안전한 공사 완료</h4>
